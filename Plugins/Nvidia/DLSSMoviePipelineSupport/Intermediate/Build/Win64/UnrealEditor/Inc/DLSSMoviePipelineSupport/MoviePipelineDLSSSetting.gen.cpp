...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bDLAAEnabled_MetaData[];
#endif
		static void NewProp_bDLAAEnabled_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bDLAAEnabled;
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_bDLAAEnabled_MetaData[] = {
		{ "Category", "DLSS/DLAA settings" },
		{ "DisplayName", "DLAA Enabled" },
		{ "ModuleRelativePath", "Public/MoviePipelineDLSSSetting.h" },
	};
#endif
	void Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_bDLAAEnabled_SetBit(void* Obj)
	{
		((UMoviePipelineDLSSSetting*)Obj)->bDLAAEnabled = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_bDLAAEnabled = { "bDLAAEnabled", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMoviePipelineDLSSSetting), &Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_bDLAAEnabled_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_bDLAAEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_bDLAAEnabled_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_DLSSQuality_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_DLSSQuality_MetaData[] = {
		{ "Category", "DLSS/DLAA settings" },
		{ "Comment", "/** DLSS quality setting, unavailable if DLAA is enabled */" },
		{ "DisplayName", "DLSS Quality" },
		{ "EditCondition", "!bDLAAEnabled" },
		{ "ModuleRelativePath", "Public/MoviePipelineDLSSSetting.h" },
		{ "ToolTip", "DLSS quality setting, unavailable if DLAA is enabled" },
	};
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_DLSSQuality = { "DLSSQuality", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMoviePipelineDLSSSetting, DLSSQuality), Z_Construct_UEnum_DLSSMoviePipelineSupport_EMoviePipelineDLSSQuality, METADATA_PARAMS(Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_DLSSQuality_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_DLSSQuality_MetaData)) }; // 1440892987
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMoviePipelineDLSSSetting_Statics::NewProp_bDLAAEnabled,
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_DLSSMoviePipelineSupport_Source_DLSSMoviePipelineSupport_Public_MoviePipelineDLSSSetting_h_Statics::EnumInfo[] = {
		{ EMoviePipelineDLSSQuality_StaticEnum, TEXT("EMoviePipelineDLSSQuality"), &Z_Registration_Info_UEnum_EMoviePipelineDLSSQuality, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1440892987U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_DLSSMoviePipelineSupport_Source_DLSSMoviePipelineSupport_Public_MoviePipelineDLSSSetting_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineDLSSSetting, UMoviePipelineDLSSSetting::StaticClass, TEXT("UMoviePipelineDLSSSetting"), &Z_Registration_Info_UClass_UMoviePipelineDLSSSetting, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineDLSSSetting), 1663029721U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_DLSSMoviePipelineSupport_Source_DLSSMoviePipelineSupport_Public_MoviePipelineDLSSSetting_h_1645101116(TEXT("/Script/DLSSMoviePipelineSupport"),
